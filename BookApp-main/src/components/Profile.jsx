  ...
  return (
    <Grid container justifyContent="space-around" m>
      <Grid item xs={12} md={4} style={{ boxShadow: "2px 2px 3px #cccccc", marginBottom: "20px" }} borderRadius={2} p={2}>
        ...
        <div style={{ display: "flex", justifyContent: "center", flexDirection: "column", paddingTop: "80px" }}>
      ...
      <Grid item xs={12} md={6} style={{ boxShadow: "2px 2px 3px #cccccc", marginBottom: "20px" }} borderRadius={2} p={2} display="flex" flexDirection={'row'}>
   <DoughnutChart/>
